<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1geracao.aspx.cs" Inherits="Site._1geracao" %>
	...
	<div id="contents">
		<div class="wrapper clearfix">
			<div id="sidebar">
				<ul>
					<li>
						<a href="Default.aspx"><img src="images/foto.jpg" alt="Img" height="154" width="213"></a>
					</li>
					<li>
						<a href="Default.aspx"><img src="images/foto0.jpg" alt="Img" height="154" width="213"></a>
					</li>
				</ul>
				
			</div>
			<div class="main">
				<h1>1ª Geração:tecnologia de válvulas (1940 - 1955)</h1>
				<ul class="list">
					<li>
						
						<h4>1943 Mark I</h4>
						<p>
							O Mark I era totalmente electromecânico: ele media cerca de 17 metros de comprimento por 2 metros e meio de altura e pesava cerca de 5 toneladas. O barulho do computador em funcionamento, segundo relatos da época, se assemelhava a varias pessoas tricotando dentro de uma sala. Mark I continha nada menos que aproximadamente 80 km de fios. Ele foi o primeiro computador totalmente automático a ser usado.
						</p>
						<a href="Default.aspx" class="more"></a>
					</li>
					<li>
